...
void loop() {
  ...
  int i;
  while (1) {
    timer = micros(); //timer sampling timer

    value = analogRead(A8) - 1560; //shift relative to zero
    ...
    while (micros() - timer < 195) //latency for fine sampling - 5120Hz this: 195.312us
      ;
